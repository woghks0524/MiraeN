...
st.sidebar.write("""
이 게임은 사용자가 만든 문제를 풀며 강화학습의 기초 개념을 학습하는 게임입니다. 문제를 만드는 사람과 문제를 푸는 사람이 차례대로 참여합니다.
- '문제 만들기'에서 9개 칸 중 개수 상관 없이 선택한 뒤 문제를 저장합니다.
- '문제 풀기'에서 문제에서 선택된 칸을 찾으며 점수를 확인합니다.
- 더블 클릭을 하면 쉽게 칸을 선택할 수 있습니다.
""")